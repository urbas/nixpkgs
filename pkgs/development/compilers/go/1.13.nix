...
stdenv.mkDerivation rec {
  ...
  '' + optionalString (stdenv.hostPlatform.parsed.cpu.name == "armv7l") ''
    # Disable a failing tests on armv7l
    rm src/os/os_unix_test.go
    rm src/os/pipe_test.go
    rm src/os/rawconn_test.go
  '';
  # +
  # TODO: Test whether this is needed on x86_64
  # optionalString (stdenv.hostPlatform.parsed.cpu.name != "armv7l") ''
  #   # Disable a failing tests on non raspbian machines
  #   rm src/os/os_test.go
  #   rm src/os/os_unix_test.go # depends on src/os/os_test.go
  #   rm src/os/pipe_test.go # depends on src/os/os_test.go
  #   rm src/os/rawconn_test.go # depends on src/os/os_test.go
  # '';
